...
bunx supabase stop --no-backup 2>/dev/null || echo "⚠️  Supabase CLI stop failed or containers already down"
...
echo "💡 You can now run 'bun run db:start' to start fresh Supabase containers" 
