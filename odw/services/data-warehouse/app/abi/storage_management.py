...
Endpoints for MinIO/S3 configuration, connection testing, and
object storage management for ABI data sources.
"""
...
s3_configure_api = ConsumptionApi[S3ConfigurationRequest, S3ConfigurationResponse](
    "configureS3Storage",
    query_function=configure_s3_storage,
    source="storage_configurations",
    config=EgressConfig()
)

s3_test_api = ConsumptionApi[S3ConnectionTest, S3ConnectionTestResponse](
    "testS3Connection",
    query_function=test_s3_connection,
    source="storage_test",
    config=EgressConfig()
)

s3_buckets_api = ConsumptionApi[S3BucketListQuery, S3BucketListResponse](
    "listS3Buckets",
    query_function=list_s3_buckets,
    source="s3_buckets",
    config=EgressConfig()
)

s3_objects_api = ConsumptionApi[S3ObjectListQuery, S3ObjectListResponse](
    "listS3Objects",
    query_function=list_s3_objects,
    source="s3_objects",
    config=EgressConfig()
)