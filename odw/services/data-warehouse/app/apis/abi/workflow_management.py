...
Endpoints for Temporal workflow management, execution monitoring,
and workflow orchestration for Azure billing data processing.
"""
...
workflow_list_api = ConsumptionApi[WorkflowListQuery, WorkflowListResponse](
    "getWorkflows",
...
workflow_trigger_api = ConsumptionApi[WorkflowTriggerRequest, WorkflowTriggerResponse](
    "triggerWorkflow",
    query_function=trigger_workflow,
    source="workflows",
    config=EgressConfig()
)

workflow_control_api = ConsumptionApi[WorkflowControlRequest, WorkflowControlResponse](
    "controlWorkflow",
    query_function=control_workflow,
    source="workflows",
    config=EgressConfig()
)

workflow_status_api = ConsumptionApi[WorkflowStatusQuery, WorkflowStatusResponse](
    "getWorkflowStatus",
    query_function=get_workflow_status,
    source="workflows",
    config=EgressConfig()
)

workflow_metrics_api = ConsumptionApi[WorkflowMetricsQuery, WorkflowMetricsResponse](
    "getWorkflowMetrics",
    query_function=get_workflow_metrics,
    source="workflows",
    config=EgressConfig()
)
