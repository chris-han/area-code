"""
Billing Analytics service layer.

Provides cost optimization, resource utilization, and service-analysis helpers
that run directly against ClickHouse for the BIA surface.
"""
