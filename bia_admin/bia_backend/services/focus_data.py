"""
FOCUS Data service helpers.

Provides FOCUS-compliant billing data query utilities with filtering,
aggregation, and analytics capabilities for the BIA FastAPI surface.
"""
